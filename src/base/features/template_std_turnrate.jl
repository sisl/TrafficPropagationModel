...
for ticks in tick_list
	...
	lstr = latexstring("\\sigma^{\\dot{\\psi}}_{$counts$unit}")

	create_feature_basics( fname_str, UnextractableFeature, "rad/s", false, false, Inf, 0.0, true, sym_feature, lstr, str_description)
